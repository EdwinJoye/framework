...
(() => {
  ...
  // src/framework/UserCollection.ts
  var UserCollection = class extends Collection {
    constructor(url2) {
      super(url2, (json) => User.build(json));
    }
    getUserById(id) {
  ...
  var User = class _User extends Model {
    static build(attrs) {
      return new _User(new Attributes(attrs), new Eventing(), new ApiSync(url));
    }
  ...
  var UserList = class extends View {
    ...
    template() {
      ...
      <div>
        ...
        <button class="select-user">Choisir cet utilisateur \xE0 \xE9diter</button>
      </div>
    `;
    }
    eventsMap() {
  ...
  var UserEdit = class extends View {
    ...
    onRender() {
      ...
      userCollection.on("change", () => {
        ...
        userList.render();
        userList.parent.addEventListener("userSelected", this.onUserSelected);
      });
      new UserShow(this.regions.userShow, this.model).render();
      new UserForm(this.regions.userForm, this.model).render();
    }
